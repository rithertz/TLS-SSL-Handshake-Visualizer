...
If the live Internet fails, the application should eventually have a
prepared demo/test mode or captured example data so that the review does
not depend entirely on network availability.
